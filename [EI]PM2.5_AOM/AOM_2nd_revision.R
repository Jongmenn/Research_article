...
g1<-gam(TOT~s(exposure,k=3,fx=T)+s(as.numeric(DATE),k=6*9)+s(AT,k=6)+dow,family="quasipoisson",data=df1)
g2<-gam(TOT~s(exposure,k=3,fx=T)+s(as.numeric(DATE),k=6*9)+s(AT,k=6)+dow,family="quasipoisson",data=df2)
g3<-gam(TOT~s(exposure,k=3,fx=T)+s(as.numeric(DATE),k=6*9)+s(AT,k=6)+dow,family="quasipoisson",data=df3)
g4<-gam(TOT~s(exposure,k=3,fx=T)+s(as.numeric(DATE),k=6*9)+s(AT,k=6)+dow,family="quasipoisson",data=df4)
g5<-gam(TOT~s(exposure,k=3,fx=T)+s(as.numeric(DATE),k=6*9)+s(AT,k=6)+dow,family="quasipoisson",data=df5)
g6<-gam(TOT~s(exposure,k=3,fx=T)+s(as.numeric(DATE),k=6*9)+s(AT,k=6)+dow,family="quasipoisson",data=df6)
g7<-gam(TOT~s(exposure,k=3,fx=T)+s(as.numeric(DATE),k=6*9)+s(AT,k=6)+dow,family="quasipoisson",data=df7)

x11();par(mfrow=c(2,4))
plot(g1,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.4),cex.main=2.5,main="Seoul",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=45,y=-0.25,label="The total of acute otitis media cases: 1,331,640",cex=1.5)
plot(g2,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.4),cex.main=2.5,main="Busan",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=45,y=-0.25,label="The total of acute otitis media cases: 304,236",cex=1.5)
plot(g3,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.4),cex.main=2.5,main="Daegu",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=45,y=-0.25,label="The total of acute otitis media cases: 279,889",cex=1.5)
plot(g4,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.4),cex.main=2.5,main="Incheon",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=45,y=-0.25,label="The total of acute otitis media cases: 433,824",cex=1.5)
plot(g5,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.4),cex.main=2.5,main="Gwangju",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=45,y=-0.25,label="The total of acute otitis media cases: 265,549",cex=1.5)
plot(g6,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.4),cex.main=2.5,main="Daejeon",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=45,y=-0.25,label="The total of acute otitis media cases: 240,853",cex=1.5)
plot(g7,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.4),cex.main=2.5,main="Ulsan" ,scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=45,y=-0.25,label="The total of acute otitis media cases: 209,176",cex=1.5)

tiff(filename="C:\\Users\\a\\Desktop\\논문\\미세먼지_AOM\\figure\\Fig.S3.tiff",width=5400,height=3200,res=300)
par(mfrow=c(2,4))
plot(g1,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.3),cex.main=2.5,main="Seoul",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=40,y=-0.25,label="The total of acute otitis media cases: 1,331,640",cex=1.45)
plot(g2,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.3),cex.main=2.5,main="Busan",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=40,y=-0.25,label="The total of acute otitis media cases: 304,236",cex=1.45)
plot(g3,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.3),cex.main=2.5,main="Daegu",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=40,y=-0.25,label="The total of acute otitis media cases: 279,889",cex=1.45)
plot(g4,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.3),cex.main=2.5,main="Incheon",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=40,y=-0.25,label="The total of acute otitis media cases: 433,824",cex=1.45)
plot(g5,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.3),cex.main=2.5,main="Gwangju",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=40,y=-0.25,label="The total of acute otitis media cases: 265,549",cex=1.45)
plot(g6,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.3),cex.main=2.5,main="Daejeon",scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=40,y=-0.25,label="The total of acute otitis media cases: 240,853",cex=1.45)
plot(g7,select=1,cex.axis=1.48,cex.lab=1.48,jit=T,xlim=c(0,80),ylim=c(-0.3,0.3),cex.main=2.5,main="Ulsan" ,scheme=1,ylab="log RR",xlab=expression(paste(PM[2.5]," (",mu,g/m^3,")")))
text(x=40,y=-0.25,label="The total of acute otitis media cases: 209,176",cex=1.45)
dev.off()
##################################################################################################################################
##################################################################################################################################
#age distribution
...
tiff(filename="C:\\Users\\a\\Desktop\\논문\\미세먼지_AOM\\figure\\Fig.S6.tiff",width=3600,height=2800,res=300)
...
time.gam<-function(i,data){
  d<-data
  g<-gam(TOT ~pm+s(as.numeric(DATE),k=i*6,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=d)
  summary(g)$p.table[2,]}
...
tiff(filename="C:\\Users\\a\\Desktop\\논문\\미세먼지_AOM\\figure\\Fig.S4.tiff",width=4000,height=3200,res=300)
...
for(i in 1:11){
  f1<-gam(TOT ~ lag(pm,i-1)+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=s1.w4)
  f2<-gam(TOT ~ lag(pm,i-1)+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=s2.w4)
  f3<-gam(TOT ~ lag(pm,i-1)+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=s3.w4)
  f4<-gam(TOT ~ lag(pm,i-1)+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=s4.w4)
  f5<-gam(TOT ~ lag(pm,i-1)+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=s5.w4)
  f6<-gam(TOT ~ lag(pm,i-1)+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=s6.w4)
  f7<-gam(TOT ~ lag(pm,i-1)+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=s7.w4)
...
tiff(filename="C:\\Users\\a\\Desktop\\논문\\미세먼지_AOM\\figure\\Fig.S5.tiff",width=4000,height=3200,res=300)
...
gam.sido<-function(data){
  ...
  for(i in 32:38){
    f1<-gam(TOT   ~ d[,i]+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=d)
    f2<-gam(TOT_M ~ d[,i]+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=d)
    f3<-gam(TOT_F ~ d[,i]+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=d)
    f4<-gam(AGE0  ~ d[,i]+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=d)
    f5<-gam(AGE13 ~ d[,i]+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=d)
...
setwd("C:\\Users\\a\\Desktop\\논문\\미세먼지_AOM\\figure")
write.csv(gam.fit,file="gam.fit.csv",row.names=F,na="")
gam.fit<-read.csv("C:\\Users\\a\\Desktop\\논문\\미세먼지_AOM\\figure\\gam.fit.csv",header=T)
##################################################################################################################################
##################################################################################################################################
###GAM 모델링 - Episode ########
################################
...
gam.season<-function(data){
  ...
  for(i in 32:38){
    f1<-gam(TOT ~ d1[,i]+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=d1)
    f2<-gam(TOT ~ d2[,i]+s(as.numeric(DATE),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=d2)
  ...
  w.fit<-as.data.frame(do.call(rbind,warm));w.fit$category="warm" ;w.fit$lag=names(d1)[32:38]
  c.fit<-as.data.frame(do.call(rbind,cold));c.fit$category="cold" ;c.fit$lag=names(d1)[32:38]
...
write.csv(fit.season,file="C:\\Users\\a\\Desktop\\논문\\미세먼지_AOM\\figure\\fit.season.csv",row.names=F,na="")
##################################################################################################################################
##################################################################################################################################
###GAM 모델링 - URI    ########
###############################
...
gam.uri<-function(data){
  ...
  for(i in 23:29){
    f1<-gam(TOT4_Y ~ d[,i]+s(as.numeric(as.factor(DATE)),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=d)
    f2<-gam(TOT4_N ~ d[,i]+s(as.numeric(as.factor(DATE)),k=6*9,fx=T)+s(AT,k=6,fx=T)+dow,family="quasipoisson",data=d)
